...
public class SmartPowerOff extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.smart_power_off);
    ...
    private void saveRebootTime(int hourOfDay, int minute) {
        String timeValue = String.format("%02d:%02d", hourOfDay, minute);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.smart_power_off) {
                @Override
